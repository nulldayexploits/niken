...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <main>
      <div class="container">
        <div class="form">
          <h5 id="lap-kec" class="mt-4 mb-3"><u>Lapor Kecurangan</u></h5>
          ...
          <div class="mb-3">
            <input type="text" class="form-control" name="pekerjaan_or_jabatan" placeholder="Pekerjaan / Jabatan">
          </div>
          <div class="mb-3">
...
if(isset($_POST['Submit'])) {
  ...
  $result = mysqli_query($mysqli, "INSERT INTO tb_laporan 
                                  (id, nama, nomor_identitas, tempat_tgl_lahir, jenis_kelamin, pekerjaan_or_jabatan, kewarganegaraan, alamat, peristiwa, tempat_kejadian, waktu, hari_tgl, terlapor, alamat_terlapor, saksi_1_nama, saksi_1_no_telp, saksi_2_nama, saksi_2_no_telp, bukti, status) 
                               VALUES(null, '$nama', '$nomor_identitas', '$tempat_tgl_lahir', '$jenis_kelamin', '$pekerjaan_or_jabatan', '$kewarganegaraan', '$alamat', '$peristiwa', '$tempat_kejadian', '$waktu', '$hari_tgl', '$terlapor', '$alamat_terlapor', '$saksi_1_nama', '$saksi_1_no_telp', '$saksi_2_nama', '$saksi_2_no_telp', '$bukti', 'BELUM DIPROSES')");
